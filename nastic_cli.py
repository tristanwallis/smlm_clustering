...
OUTPUT:
inputfilename_YYYYMMDD-HHMMSS_nastic_metrics.tsv --> clustering metrics 
...
# Logfile name and header
infilename_split = infilename.split(".")
prefix = str(infilename_split[0])
suffix = str(infilename_split[-1])
...
print ("Generating trajectory bounding boxes...")
seldict = {}
sel_centroids = []
...
# Save metrics
outfilename = infilename.replace(".trxyt" ,"_{}_nastic_metrics.tsv".format(stamp))
